...
Sub SBTTreplace(ByVal SBPath as String)
		...
		ufs.Weight.EstabPartProps1(workPart.Tag, 0.9, True, wtype, wprops, exceptions)
		
		
		Dim NewMASS as string
		Dim CalcMass as double
		NewMASS = wprops.mass
		
		CalcMass = Convert.ToDouble(wprops.mass)
		CalcMass = Math.Round(CalcMass, 2)
		CalcMass = CalcMass + 0.2
		NewMass = CStr(CalcMass)
		workPart.SetUserAttribute("MASSA", -1, NewMASS, Update.Option.Now)
