...
end1:
    ...
    Sub EditDimensionTolerance(ByVal selecteddim As NXObject)
        Dim dimname1 As String = selecteddim.ToString
			...
			' * на размеры
			linearDimensionBuilder1.Style.DimensionStyle.ToleranceType = NXOpen.Annotations.ToleranceType.Reference
			linearDimensionBuilder1.Style.DimensionStyle.ReferenceDimension = False
