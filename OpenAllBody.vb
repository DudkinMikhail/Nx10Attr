...
Module NXJournal
	...
	Sub Main(ByVal args() As String)
		...
		For Each foundFile As String In My.Computer.FileSystem.GetFiles("K:\Industrial\КД\Ящики злектрические",FileIO.SearchOption.SearchAllSubDirectories, "*001 Корпус.prt")
