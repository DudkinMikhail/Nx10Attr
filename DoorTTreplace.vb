...
Module NXJournal
	Sub Main(ByVal args() As String)
		...
		For Each foundFile As String In My.Computer.FileSystem.GetFiles("K:\Industrial\КД\Ящики злектрические",FileIO.SearchOption.SearchAllSubDirectories, "*400.001 Дверь наружная.prt")
			DoorTTreplace(foundFile)
		Next
	End sub


	Sub DoorTTreplace(ByVal DoorPath as String)
		'Открываем файл с дверью
		Dim theSession As NXOpen.Session = NXOpen.Session.GetSession()
		Dim basePart1 As NXOpen.BasePart
		Dim partLoadStatus1 As NXOpen.PartLoadStatus
		basePart1 = theSession.Parts.OpenBaseDisplay(DoorPath, partLoadStatus1)
