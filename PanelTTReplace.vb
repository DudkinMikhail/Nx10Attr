...
Module NXJournal
	...
	Sub PanelTTreplace(ByVal SBPath as String)
		...
		NewSBTT = InputBox(SBPath, "1 - Меняем, 0 - Нет", "0")
		
			if NewSBTT = "1" then
				'Замена ТТm
				Dim readText() As String = File.ReadAllLines("C:\SWPlus\NX10\Тектовые шаблоны\ТТ Панель окрашиваемая.txt")
